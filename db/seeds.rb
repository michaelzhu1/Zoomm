...
guest = User.create(
  ...
  cover_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506715469/guest/guest_cover.jpg",
  profile_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506711691/guest/guest_profile.jpg"
)
michael = User.create(
  username: "Michael",
  password: "mike123",
...
liam = User.create(
  ...
  password: "liam123",
  bio: "Coffee Lover",
  cover_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506710569/liam/liam_cover.jpg",
  profile_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506709989/liam/liam_profile.jpg"
)
noah = User.create(
  username: "Noah",
  password: "noah123",
  bio: "Fitness is life. Stay active.",
  cover_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506710525/noah/noah_cover.jpg",
  profile_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506709958/noah/noah_profile.jpg"
)
emma = User.create(
  username: "Emma",
  password: "emma123",
  bio: "An avid photographer from New York who loves taking food pictures.",
  cover_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506710599/emma/emma_cover.jpg",
  profile_img_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506709978/emma/emma_profile.jpg"
)
jessica = User.create(
  username: "Jessica",
  password: "jessica123",
...
g1 = Photo.create(
  author_id: guest.id,
  photo_title: "Getaway",
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/c_scale,w_1280/v1506711693/guest/photo-1505841392587-67bfc23db3f9.jpg",
  photo_description: ""
)
...
g2 = Photo.create(
  ...
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/c_scale,w_1280/v1506711692/guest/photo-1504448252408-b32799ff32f3.jpg",
  photo_description: ""
)
...
g3 = Photo.create(
  author_id: guest.id,
  photo_title: "Map",
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/c_scale,w_1280/v1506711693/guest/photo-1497302347632-904729bc24aa.jpg",
  photo_description: ""
)
...
g4 = Photo.create(
  author_id: guest.id,
  photo_title: "Desert",
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506711692/guest/photo-1494596386710-d1f5ab0d4109.jpg",
  photo_description: ""
)
...
g5 = Photo.create(
  ...
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/v1506711691/guest/photo-1487662701465-ee09afb4e1fa.jpg",
  photo_description: ""
)
...
g6 = Photo.create(
  ...
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/c_scale,w_1280/v1506715821/guest/1.jpg",
  photo_description: ""
)
...
g7 = Photo.create(
  author_id: guest.id,
  photo_title: "Transit",
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/c_scale,w_1280/v1506715821/guest/2.jpg",
  photo_description: ""
)
...
g8 = Photo.create(
  ...
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/c_scale,w_1280/v1506715822/guest/3.jpg",
  photo_description: ""
)
...
g9 = Photo.create(
  ...
  photo_url: "http://res.cloudinary.com/foolishhunger/image/upload/c_scale,w_1280/v1506715821/guest/4.jpg",
  photo_description: ""
)
