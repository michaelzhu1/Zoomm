...
import { startLoading } from "./loading_action";
...
export const fetchPhotos = () => dispatch =>{
  ...
  return APIUtil.fetchPhotos().then(photos => dispatch(receiveAllPhotos(photos)));
};
...
export const fetchUserFeed = () => dispatch => {
  dispatch(startLoading());
  return APIUtil.fetchUserFeed().then(photos => dispatch(receiveAllPhotos(photos)));
};
